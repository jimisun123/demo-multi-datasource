 ...
 **/
@Configuration
@MapperScan(basePackages = "com.jimisun.simple.basicmultidatasource.mapper.master", sqlSessionFactoryRef = "masterSqlSessionFactory")
public class MasterMybatisConfig {
    ...
    public SqlSessionFactory masterSqlSessionFactory(@Qualifier("master") DataSource dataSource) throws Exception {
        ...
        //对应数据库的entity位置
        String typeAliasesPackage = "com.jimisun.simple.basicmultidatasource.entity.master";
